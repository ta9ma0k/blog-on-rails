...
ActiveRecord::Schema[7.2].define(version: 2024_10_01_031640) do
  ...
  create_table "posts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "body", limit: 140, null: false, comment: "投稿内容"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", null: false, comment: "ユーザ名(ログインID)"
    t.string "email", null: false, comment: "メールアドレス"
    t.string "encrypted_password", null: false, comment: "暗号化されたパスワード"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "profile", limit: 200, comment: "プロフィールコメント"
    t.string "blog_url", comment: "ブログURL"
